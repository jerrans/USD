    ...
    wgpu::BindGroupEntry const &constantBindGroupEntry)
{
    ...
    if (_bindGroup == nullptr && _textureBindGroup == nullptr && _samplerBindGroup == nullptr) {
    ...
    } else if (_bindGroup == nullptr || _textureBindGroup == nullptr || _samplerBindGroup == nullptr) {
...
void HgiWebGPUResourceBindings::BindResources(
        ...
        wgpu::BindGroupEntry const &constantBindGroupEntry)
{
    _CreateBindGroups(device, bindGroupLayoutList, constantBindGroupEntry);
    if (_bindGroup && _textureBindGroup && _samplerBindGroup) {
        passEncoder.SetBindGroup(HgiWebGPUBufferShaderSection::bindingSet, _bindGroup, 0, 0);
        passEncoder.SetBindGroup(HgiWebGPUTextureShaderSection::bindingSet, _textureBindGroup, 0, 0);
        passEncoder.SetBindGroup(HgiWebGPUSamplerShaderSection::bindingSet, _samplerBindGroup, 0, 0);
